<?php
require_once('controles/pais.php');
Processo('consulta');
?>
...
<br />
				...
				<?php for($i=0;$i<$linha;$i++){?>
                                    <tr class="table-flag-blue">
                                      ...
                                      <td><a class="btn btn-small show-tooltip" title="Editar" href="default.php?pg=<?php echo base64_encode('visao/pais/editar.php')?>&form=Atualizar / País&id=<?php echo $rs[$i]['idpais']?>">Editar</a></td>
                                    </tr>
				<?php }?>
                                  </tbody>
                                </table>
