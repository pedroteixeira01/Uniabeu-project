...
<h2 class="panel-title">Atualização de Colégio</h2>
</header>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 control-label">
                <div class="input-group">
                    ...
                    <input name="descricao" class="form-control" id="descricao" title="O campo Colégio é obrigatório" value="<?php echo $rsEditar[0]['descricao'];?>"> 
...
<script>
document.form.idpais.value='<?php echo $rsEditar[0]['idpais'];?>';    
</script>    