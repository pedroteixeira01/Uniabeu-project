...
<h2 class="panel-title">Cadastro de Programação</h2>
</header>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="input-daterange input-group" data-plugin-datepicker>
                    ...
                    <input type="text" class="form-control" name="data_programacao" id="data_programacao" title="O campo Data é obrigatório">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 control-label">
                <div class="input-group">
                    ...
                    <input name="horario" class="form-control" id="horario" title="O campo horário é obrigatório"> 
