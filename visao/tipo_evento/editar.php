...
<h2 class="panel-title">Atualização do Tipo de Evento</h2>
</header>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 control-label">
                <div class="input-group">
                    ...
                    <input name="descricao" class="form-control" id="descricao" title="O campo Tipo de Evento é obrigatório" value="<?php echo $rsEditar[0]['descricao'];?>"> 
