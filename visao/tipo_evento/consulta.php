<?php
require_once('controles/tipo_evento.php');
Processo('consulta');
?>
...
<br />
				...
				<?php for($i=0;$i<$linha;$i++){?>
                                    <tr class="table-flag-blue">
                                      ...
                                      <td><a class="btn btn-small show-tooltip" title="Editar" href="default.php?pg=<?php echo base64_encode('visao/tipo_evento/editar.php')?>&form=Atualizar / Tipo de Evento&id=<?php echo $rs[$i]['idtipo_evento']?>">Editar</a></td>
                                    </tr>
				<?php }?>
                                  </tbody>
                                </table>
