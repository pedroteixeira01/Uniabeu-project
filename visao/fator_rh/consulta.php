<?php
require_once('controles/fator_rh.php');
Processo('consulta');
?>
...
<br />
				...
				<?php for($i=0;$i<$linha;$i++){?>
                                    <tr class="table-flag-blue">
                                      ...
                                      <td><a class="btn btn-small show-tooltip" title="Editar" href="default.php?pg=<?php echo base64_encode('visao/fator_rh/editar.php')?>&form=Atualizar / Fator RH&id=<?php echo $rs[$i]['idfator_rh']?>">Editar</a></td>
                                    </tr>
				<?php }?>
                                  </tbody>
                                </table>
