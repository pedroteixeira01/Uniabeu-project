...
(function($) {
    ...
    function resetFileTab($fileTab) {
        ...
        $fileTab.find('.btn span').text('Escolha o arquivo / escoge el archivo');
    ...
    function submitImageFile($fileTab) {
        ...
        $fileTab.find('.alert').remove();
        $fileTab.find('img').remove();
        $browseFileButton.find('span').text('Escolha o arquivo / escoge el archivo');
        ...
        isValidImageFile(file, function(isValid, message) {
            if (isValid) {
                ...
                fileReader.onload = function(e) {
                    ...
                    $browseFileButton.find('span').text('Alterar / Cambiar');
